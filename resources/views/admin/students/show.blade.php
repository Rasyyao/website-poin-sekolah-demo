    ...
    <div class="bg-surface-light rounded-2xl border border-gray-700/50 p-6 flex flex-col items-center text-center shadow-lg relative overflow-hidden h-fit">
        ...
        <div class="w-full space-y-3 z-10">
            ...
            <div class="grid grid-cols-2 gap-3">
                <a target="_blank" href="{{ route('admin.reports.student.export.pdf', $student) }}" class="flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-surface border border-red-500/30 text-red-400 text-sm font-medium hover:bg-red-500/10 transition-colors">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 10v4h2"/></svg>
                    Export PDF
                </a>
                <a target="_blank" href="{{ route('admin.reports.student.export.excel', $student) }}" class="flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-surface border border-green-500/30 text-green-400 text-sm font-medium hover:bg-green-500/10 transition-colors">
    ...
    <div class="lg:col-span-2 space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="bg-surface-light rounded-xl border border-gray-700/50 p-5">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold mt-1 {{ $totalPoints > 0 ? 'text-red-400' : ($totalPoints < 0 ? 'text-green-400' : 'text-gray-200') }}">{{ abs($totalPoints) }}</p>
                    </div>
            ...
            <div class="bg-surface-light rounded-xl border border-gray-700/50 p-5">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm text-gray-400">Pelanggaran</p>
